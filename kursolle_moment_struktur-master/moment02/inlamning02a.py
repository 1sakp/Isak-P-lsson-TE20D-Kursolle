...
pi = 3.14
radie = float(input("Skriv radie med decimaler aka med punkt: "))

#Här räknar jag ut och printar dem olika delarna. Jag använder \u00b2 på arean så att det ska se fint ut. 
#Samtidigt så använder jag {:.2f} för att få 2 decimaler istälet för fler eller färre.
